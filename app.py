...
with open(
        r"C:\Users\HP\Desktop\PORTFOLIO\bangalore_home_prices_model.pickle",
        'rb') as f:
    linear=pickle.load(f)



with open(r"C:\Users\HP\Desktop\PORTFOLIO\columns.json", 'r') as obj:
...
def main():
    ...
    <h2 style="color:black";text-align:center;"> streamlit house prediction app </h2>
    </div>
    """
